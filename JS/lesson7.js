...
const statistic = {
    ...
    render () {
        let statisticBlock = document.getElementById('gameResult');
        statisticBlock.innerText = statistic.getResult();        
    },
...
const game = {
    ...
    tickHandler() {
        ...
        if (this.barrier.isOnPoint(this.snake.getNextHeadPoint())) return this.finish();
